...
versions=$(npm view create-vite versions --json)
...
do
  ...
  then
    ...
    then
      ...
      diffUrl="[${lastVersion}...${version}](https://github.com/cexbrayat/vite-create-diff/compare/${lastVersion}...${version})"
      git checkout main
...
NEWLINE/g' README.md && rm README.md.bak
  ...
  npm init vite@${version} ponyracer --template vue-ts
  git add ponyracer
